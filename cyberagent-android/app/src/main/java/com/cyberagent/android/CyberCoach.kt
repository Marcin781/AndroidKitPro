...
object CyberCoach {
    fun advice(findings: List<AppScanner.AppFinding>): String {
        ...
        return when {
            high > 0 -> "Wykryto $high aplikacji wymagających pilnego przeglądu. Nie wykonuj automatycznie nieodwracalnych działań; sprawdź nazwę pakietu, uprawnienia i SHA-256."
